...
#   ipdb.set_trace()
  ...
  if cfg.task.type == "pretrain":
    sequence, seqName, seqID, label_dict = clear_pretrained_data(all_data,vocab_dict,cfg)
    # ipdb.set_trace()
...
def make_loader(local_rank,
    ...
    if cfg.task.type == 'rank':
        sequence1, sequence2, pairID, label_dict  = load_raw_seq(dataset_file,vocab_dict,cfg)
        ...
        '''
        sequences1 = {'peptide':sequence1}
        sequences2 = {'peptide':sequence2}
        ...
        dataloader = generate_dataloader_pair(sequences1, sequences2,pairID, label_dict, cfg.mode.ddp, local_rank, batch_size, num_workers, pin_memory, collate_fn_pair)
        ...
        dataloader = generate_dataloader(sequences, seqName, seqID, label_dict, cfg.mode.ddp, local_rank, batch_size, num_workers, pin_memory, collate_fn)
